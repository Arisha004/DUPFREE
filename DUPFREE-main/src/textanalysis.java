...
//type-token ratio
    public static double calcTTR(String text) { //(whats the diversity of vocabulary used in given text)
...
//A higher TTR (closer to 1) indicates a diverse vocabulary.
//A lower TTR (closer to 0) suggests repetition or limited vocabulary.
